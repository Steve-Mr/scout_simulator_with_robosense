...
exports.generateActionMessage = exports.generateActionFeedbackMessage = exports.generateActionResultMessage = exports.generateActionGoalMessage = exports.createServiceClass = exports.createMessageClass = void 0;
const util = require("util");
const IndentedWriter_1 = require("./IndentedWriter");
const fieldsUtil = require("./fields");
function createMessageClass(msgSpec) {
    let w = new IndentedWriter_1.default();
...
function createServiceClass(srvSpec) {
    let w = new IndentedWriter_1.default();
...
function generateActionGoalMessage(messageName) {
...
exports.generateActionGoalMessage = generateActionGoalMessage;
function generateActionResultMessage(messageName) {
    const w = new IndentedWriter_1.default();
    w.write('# ===== DO NOT MODIFY! AUTOGENERATED FROM ACTION DEFINITION =====')
        .write('std_msgs/Header header')
...
exports.generateActionResultMessage = generateActionResultMessage;
function generateActionFeedbackMessage(messageName) {
    const w = new IndentedWriter_1.default();
    w.write('# ===== DO NOT MODIFY! AUTOGENERATED FROM ACTION DEFINITION =====')
        .write('std_msgs/Header header')
        .write('actionlib_msgs/GoalStatus status')
...
exports.generateActionFeedbackMessage = generateActionFeedbackMessage;
function generateActionMessage(messageName) {
    const w = new IndentedWriter_1.default();
    w.write('# ===== DO NOT MODIFY! AUTOGENERATED FROM ACTION DEFINITION =====')
